  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        padding: "130px 40px 80px", width: "100%",
      }}>
        <div style={{ maxWidth: "680px" }}>
          ...
          <p style={{
            ...
            color: "var(--fg-muted)", fontWeight: 300,
            maxWidth: "530px", marginBottom: "36px",
          }}>
        ...
        <div className="hero-float-card" style={{
          ...
          display: "none", flexDirection: "column", gap: "12px", width: "230px",
        }}>
          {["Cedro Andino", "Tornillo Selecto", "Ébano Africano"].map((wood, i) => (
            <div key={wood} style={{
              ...
              <div>
                <div style={{ fontSize: "0.72rem", color: "var(--foreground)", fontWeight: 500, marginBottom: "2px" }}>{wood}</div>
                <div style={{ fontSize: "0.6rem", color: "var(--gold-primary)", letterSpacing: "0.08em" }}>Madera Noble</div>
              </div>
            </div>
          ))}
        </div>
