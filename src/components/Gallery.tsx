...
const PROJECTS = [
  ...
  { id:7, title:"Puerta de Madera con Tableros",     category:"puertas-ventanas",   wood:"Tornillo Nacional",                   fabric:"Cerradura de Seguridad Multipunto",          image:"/galeria/puerta1.jpeg",       description:"Puerta clásica de exterior con finos acabados y protección de barniz marino contra la intemperie." },
  { id:8, title:"Puerta de Paso Moderna",            category:"puertas-ventanas",   wood:"MDF enchapado en Cedro",              fabric:"Bisagras Ocultas de Presión",                image:"/galeria/puerta2.jpeg",       description:"Puerta interior con líneas minimalistas y marco cajón diseñado a la medida de tu espacio." },
  { id:9, title:"Puerta Principal de Lujo",          category:"puertas-ventanas",   wood:"Cedro Andino Tratado",                fabric:"Manijón de Acero Inoxidable de 1.2m",        image:"/galeria/puerta3.jpeg",       description:"Puerta de gran formato para acceso residencial con chapa inteligente y acabado satinado." },
  { id:10, title:"Cama con Cabecera Tapizada",       category:"dormitorios-closets", wood:"Estructura de Pino y Melamina",       fabric:"Tapicería Premium Antifluidos",              image:"/galeria/cabecera_tapizada.png", description:"Juego de dormitorio de diseño moderno con cajones flotantes y luces led integradas." },
  { id:11, title:"Tocador Flotante Premium",         category:"dormitorios-closets", wood:"Melamina de Alta Densidad",           fabric:"Espejo con Iluminación Led Touch",           image:"/galeria/tocador_premium.png",  description:"Tocador moderno flotante con organizadores de maquillaje integrados y cajón oculto de terciopelo." },
  { id:12, title:"Mesa de Noche de Diseño",          category:"dormitorios-closets", wood:"Enchapado en Ébano y Laca",           fabric:"Rieles Telescópicos de Apertura Push",       image:"/galeria/mesa_noche_ebano.png", description:"Mesa de noche de líneas contemporáneas y cajón espacioso para dormitorio principal." },
  { id:13, title:"Aparador Consola de Sala",         category:"oficina-otros",      wood:"Cerezo en Acabado Natural",           fabric:"Patas de Acero con Pintura Electrostática",  image:"/galeria/aparador_consola.png", description:"Aparador funcional para sala o comedor con puertas batientes y nichos de exhibición." },
  { id:14, title:"Mesa de Comedor de Lujo",          category:"oficina-otros",      wood:"Estructura de Cedro Cajamarquino",    fabric:"Acabados en Laca de Poliuretano Mate",       image:"/galeria/comedor_lujo.png",     description:"Mesa de comedor de gran capacidad y diseño escultural para espacios sociales sofisticados." },
  { id:15, title:"Escritorio Ejecutivo Premium",     category:"oficina-otros",      wood:"Melamina Texturizada y Cedro",        fabric:"Pasacables y Bandeja Organizadora Oculta",   image:"/galeria/escritorio_ejecutivo.png", description:"Escritorio corporativo de ebanistería fina con diseño ergonómico y cajonera integrada." },
  { id:16, title:"Librero Integrado de Pared",       category:"oficina-otros",      wood:"Madera de Pino y Melamina",           fabric:"Soporte de Repisas de Carga Pesada",         image:"/galeria/librero_integrado.png", description:"Librero empotrado para estudio o sala con iluminación acentuada en repisas." },
  { id:17, title:"Mesa de Centro Escultural",        category:"oficina-otros",      wood:"Madera Maciza de Origen Legal",       fabric:"Ensamble Artesanal Oculto",                  image:"/galeria/mesa_centro_escultural.png", description:"Mesa de centro con forma orgánica que resalta las vetas naturales y el brillo de la madera." },
  { id:18, title:"Revestimiento y Paneles Acústicos",category:"oficina-otros",      wood:"Listones de Madera de Cedro",         fabric:"Fieltro Acústico de Alta Absorción",         image:"/galeria/paneles_acusticos.png",description:"Diseño e instalación de paneles decorativos de madera para salas de reunión o TV." },
  { id:19, title:"Silla de Diseño Ebanis",           category:"oficina-otros",      wood:"Madera Curvada de Fresno/Tornillo",    fabric:"Asiento Ergonómico Tapizado",                image:"/galeria/silla_diseno.png",   description:"Silla de comedor o escritorio de alta costura con ensambles tradicionales expuestos." },
  { id:20, title:"Barra Desayunadora en Madera",     category:"cocinas",             wood:"Madera Maciza de Alta Resistencia",   fabric:"Barniz Poliuretánico Apto Alimentos",        image:"/galeria/barra.jpeg",          description:"Barra desayunadora para cocina americana con vetas pronunciadas y soportes estructurales ocultos." },
  { id:21, title:"Barra de Bar Residencial",         category:"cocinas",             wood:"Madera Maciza Tratada",               fabric:"Luces LED Calientes y Repisas",              image:"/galeria/barra1.jpeg",         description:"Elegante barra de tragos e iluminación para zonas sociales y de entretenimiento." },
  { id:22, title:"Escalera Flotante en Obra",        category:"oficina-otros",      wood:"Peldaños de Madera Maciza",           fabric:"Estructura Metálica Oculta",                 image:"/galeria/escalera1.jpeg",     description:"Peldaños de madera maciza instalados con precisión geométrica y acabados de alto tránsito." },
  { id:23, title:"Estantería Abierta Decorativa",    category:"oficina-otros",      wood:"Estructura Metálica y Repisas Madera",fabric:"Acabado en Laca de Poliuretano",            image:"/galeria/estanteria1.jpeg",   description:"Estantería de diseño industrial moderno con repisas de madera maciza de alta densidad." },
  { id:24, title:"Estantería Minimalista de Pared",  category:"oficina-otros",      wood:"Madera Maciza Seleccionada",          fabric:"Soportes Invisibles de Pared",               image:"/galeria/estanteria.jpeg",    description:"Estante flotante de madera maciza para exhibición minimalista y libros decorativos." },
  { id:25, title:"Instalación de Muebles a Medida",  category:"oficina-otros",      wood:"Melamina y Pino Premium",             fabric:"Bisagras de Presión Cierre Suave",           image:"/galeria/instalacion.jpeg",   description:"Proceso de instalación y ensamble milimétrico por nuestros maestros ebanistas." },
  { id:26, title:"Piso de Madera Machihembrada",     category:"oficina-otros",      wood:"Madera Tornillo/Guayacán",            fabric:"Puliuretano Alto Tránsito Brillo",          image:"/galeria/piso.jpeg",          description:"Instalación y pulido de piso de madera machihembrada de alta resistencia y durabilidad." }
];
